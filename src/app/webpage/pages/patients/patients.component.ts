...
@Component({
    ...
    standalone: true,
    imports: [SectionBannerComponent, HowItWorksComponent, SpecificationSectionComponent, FAQSectionComponent],
    ...
    public specificationsArray: Specifications[] = [
        {
            ...
            caption: "No more calling around to find in-stock meds"
        },
        {
            imagePath: "assets/images/svg/check-icon.svg",
            caption: "We'll find your meds or it\'s free"
        },
    ]
}
